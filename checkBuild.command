...
set -o pipefail && xcodebuild -project "Carthage Project/ViewState.xcodeproj" -sdk iphonesimulator -target "Example" | xcpretty
...
set -o pipefail && xcodebuild -project "Carthage Project/ViewState.xcodeproj" -sdk iphonesimulator -scheme "Example" -destination "platform=iOS Simulator,id=${simulator_id}" test | xcpretty
